...
import brand from '../../public/assets/images/base/index/service-section/brand.svg'
...
const Services = () => {
  const boxes = [
    ...
    },
    {
      ...
      img: illus,
      title: 'تجربه کاربری',
      desc: 'ایجاد تجربه کاربری روان و ساده برای مشتریان و کاربران سایت'
    },
    {
      id: 4,
      img: marketing,
      title: 'طراحی تجاری',
      desc: 'طراحی تجاری کاملا بروز و حرفه ای بر اساس نیاز مشتریان'
    },
  ]
  return (
